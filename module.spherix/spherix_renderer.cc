...
IX_BEGIN_DECLARE_MODULE_CALLBACKS(ModuleRendererSpherix, ModuleRendererCallbacks)
...
IX_END_DECLARE_MODULE_CALLBACKS(ModuleRendererSpherix)

MODULE_CLASS *
IX_MODULE_CLBK::declare_module(OfObject& object, OfObjectFactory& objects)
{
    ModuleRendererSpherix *settings = new ModuleRendererSpherix;
...
{
    supported_lights = SpherixRenderDelegate::s_supported_lights;
    unsupported_lights = SpherixRenderDelegate::s_unsupported_lights;
}
...
{
    supported_geometries = SpherixRenderDelegate::s_supported_geometries;
    unsupported_geometries = SpherixRenderDelegate::s_unsupported_geometries;
}
...
{
    supported_materials = SpherixRenderDelegate::s_supported_materials;
    unsupported_materials = SpherixRenderDelegate::s_unsupported_materials;
}

namespace SpherixRenderer
{
    void on_register(OfApp& app, CoreVector<OfClass *>& new_classes)
    {
        OfClass *new_class = IX_DECLARE_MODULE_CLASS(ModuleRendererSpherix)
