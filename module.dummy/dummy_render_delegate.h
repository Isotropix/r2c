...
class DummyRenderDelegate : public R2cRenderDelegate {
public:

    DummyRenderDelegate(OfApp *app);
    virtual ~DummyRenderDelegate() override;
...
private:
    ...
    void sync_new_geometry(R2cItemId cgeometryid, DummyGeometryInfo& rgeometry) { _sync_geometry(cgeometryid, rgeometry, true); }
     ...
     *  \param rgeometry dummy geometry handle */
    void sync_geometry(R2cItemId cgeometryid, DummyGeometryInfo& rgeometry) { _sync_geometry(cgeometryid, rgeometry, false); }
    ...
    void _sync_geometry(R2cItemId cgeometryid, DummyGeometryInfo& rgeometry, const bool& is_new);
    ...
    inline void sync_new_instancer(R2cItemId cinstancerid, DummyInstancerInfo& rinstancer) { _sync_instancer(cinstancerid, rinstancer, true); }
     ...
     *  \param rinstancer dummy instancer definition handle */
    inline void sync_instancer(R2cItemId cinstancerid, DummyInstancerInfo& rinstancer) { _sync_instancer(cinstancerid, rinstancer, false); }
    ...
    void _sync_instancer(R2cItemId cinstancerid, DummyInstancerInfo& rinstancer, const bool& is_new);
    ...
    DummyDelegateImpl *m; // private implementation
    DECLARE_CLASS
};
